...
import { CircuitStudioError } from "@/types"
...
export interface LongTask {
    ...
    eventProgress: GenericEvent<Progress>
}
...
export default class JsonRpcService {
    public readonly eventConnectionStatus = new GenericEvent<boolean>()

    public readonly eventUpdate = new GenericEvent<JsonRpcUpdate>()

    constructor(public readonly address: JsonRpcServiceAddress) {}
