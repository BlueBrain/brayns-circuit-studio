...
const RX_RGBA =
    /^RGBA[\s(?:]+(?:[0-9]+)[^0-9]+(?:[0-9]+)[^0-9]+(?:[0-9]+)[^0-9.]+(?:[0-9.]+)/u
...
export default class Color {
    ...
    /**
     * Return 1 if you need a bright text on the given color,
     * and 0 if you need a dark text.
     *
     * If the color is invalid, return -1.
     */
    public static luminanceStep(
        colorOrString: ColorOrString
    ): typeof INVALID_COLOR | 0 | 1 {
