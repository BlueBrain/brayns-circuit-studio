...
export class LimitedCacheMap<KeyType, ValueType> {
    ...
    constructor(
        ...
        private readonly computeLength: (item: ValueType) => number = () => 1
    ) {}
...
export class LimitedStringCacheMap<KeyType = string> extends LimitedCacheMap<
    KeyType,
    string
> {
