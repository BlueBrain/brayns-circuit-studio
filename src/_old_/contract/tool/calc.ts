...
export default abstract class CalcInterface {
     ...
     */
    abstract bezierCubic<T extends Vector>(
        p0: T,
        p1: T,
        p2: T,
        p3: T,
     ...
     * the vector `axis`.
     */
    abstract getQuaternionAsAxisRotation(
        angle: number,
        axis: Vector3
    ): Quaternion
     ...
     */
    abstract rotateQuaternionAroundVector(
        quat: Quaternion,
        vec: Vector3,
        ang: number
    ): Quaternion
     ...
     */
    abstract rotateVectorAroundVector(
        vector: Vector3,
        axis: Vector3,
        ang: number
    ): Vector3
    ...
    abstract computeBoundingBoxCenter(boundingBox: {
        min: Vector3
        max: Vector3
    }): Vector3
     ...
     */
    abstract computeBoundingBoxesUnion(
